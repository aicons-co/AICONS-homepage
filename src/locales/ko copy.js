export default {
  ...
  hero: {
    ...
    projectWith: '프로젝트를',
    subtitle: '수백만 가지의 건설 시나리오를 시뮬레이션하여 최적의 일정을 찾으세요. 비용 절감, 리스크 완화, 정시 납품을 달성하세요.',
    watchVideo: '시현 영상',
    durationReduction: '공기 단축',
  ...
  features: {
    ...
    titleEnd: '인가요?',
    subtitle: 'AI 기반 플랫폼이 건설 프로젝트의 계획과 실행 방식을 혁신합니다.',
  ...
  productsSection: {
    title: '제품 소개',
    subtitle: '프로젝트 요구사항에 맞는 솔루션을 선택하세요',
    learnMore: '자세히 보기',
    plan: {
      tagline: '일정 시각화 및 계획',
      description: '지능형 일정 시각화로 프로젝트 타임라인을 혁신하세요.',
      steps: {
  ...
  metrics: {
    title: '검증된 성과',
    subtitle: '고객들이 지속적으로 측정 가능한 개선을 달성합니다',
    durationReduction: {
      label: '공기 단축',
      description: '전체 프로젝트 타임라인 평균 단축률',
    },
    laborSavings: {
      label: '인건비 절감',
  ...
  cta: {
    ...
    subtitle: '이미 수백 개의 건설 팀이 AISIMS를 사용하여 일정을 최적화하고 비용을 절감하고 있습니다.',
    contactSales: '영업팀 문의',
  },
  ...
  productsPage: {
    ...
    plan: {
      tagline: '일정 시각화 및 계획',
      description: '지능형 일정 시각화로 프로젝트 타임라인을 혁신하세요. AICONS Plan은 건설 일정에 생명을 불어넣는 강력한 4D 시각화 도구를 제공합니다.',
      features: [
        '대화형 4D 일정 시각화',
        '실시간 일정 업데이트',
        '자원 충돌 감지',
    ...
    optimize: {
      ...
      benefits: {
        durationReduction: { title: '17% 공기 단축', description: '평균 프로젝트 타임라인 개선' },
  ...
  solutionsPage: {
    ...
    gc: {
      name: '종합건설사',
      tagline: '건설 운영 최적화',
      description: 'AICONS는 AI 기반 일정 최적화를 통해 종합건설사가 정시에 예산 내에서 프로젝트를 완수하도록 돕습니다.',
      challenges: [
        '복잡한 일정 조율',
        '자원 배분 충돌',
        '리스크 관리',
    ...
    owners: {
      name: '발주자',
      tagline: '투자 가치 극대화',
      description: 'AICONS는 데이터 기반 인사이트로 발주자에게 건설 프로젝트에 대한 가시성과 통제력을 제공합니다.',
      challenges: [
        '제한된 프로젝트 가시성',
        '일정 신뢰성 우려',
        '비용 초과 리스크',
    ...
    consultants: {
      ...
      description: 'AICONS는 컨설턴트가 더 정확한 일정 자문 및 프로젝트 관리 서비스를 제공할 수 있도록 지원합니다.',
      challenges: [
        '수동 일정 관리 프로세스',
        '제한된 최적화 역량',
        '시간 소모적인 분석',
    ...
    industrial: {
      name: '산업시설 프로젝트',
      tagline: '복잡한 산업 건설',
      description: 'AICONS는 고급 시퀀싱 및 최적화로 산업 건설의 복잡성을 처리합니다.',
      features: [
        '모듈 설치 시퀀싱',
        '장비 조율',
        '셧다운 계획',
    ...
    infrastructure: {
      name: '인프라 프로젝트',
      tagline: '대규모 인프라',
      description: 'AICONS는 여러 작업 전선에 걸친 인프라 프로젝트의 규모와 복잡성을 관리합니다.',
      features: [
        '다중 전선 조율',
        '선형 프로젝트 일정 관리',
        '이해관계자 관리',
    ...
    commercial: {
      name: '상업시설 프로젝트',
      tagline: '상업 건물 건설',
      description: 'AICONS는 시장 출시 속도와 비용 효율성을 위해 상업 건설 프로젝트를 최적화합니다.',
      features: [
        '패스트트랙 일정 관리',
        '임차인 조율',
        '마감 최적화',
