export default {
  ...
  companyPage: {
    ...
    vision: {
      ...
      detail: 'AICONS는 건설 산업을 자동화하는 AI 서비스를 제공하는 기업입니다. 구조설계 데이터를 파싱하여 시공·조달·공정까지 연결하는 자동화 라인을 구축합니다. BIM 자동 생성·물량 산출·공정 계획을 하나의 파이프라인으로 통합하여 설계와 시공 간의 단절을 해소합니다. 설계 변경시 전 공정이 자동 갱신되어, 반복적인 수작업과 일정 지연을 예방합니다.',
      pipeline: '구조설계서 → 구조 DB → BIM 자동생성 → 물량/공정/조달 자동화',
    },
    problem: {
      title: '건설산업의 구조적 단절',
      subtitle: 'BIM은 도입되었으나, 현장의 실행(Execution)은 여전히 자동화되지 않았습니다.',
      items: {
        isolation: { title: '정보의 고립', description: '구조설계서는 PDF/보고서 형태로 존재하며, 시공 단계에서 데이터가 단절됩니다.' },
        manual: { title: '수작업 의존', description: '실시설계, 물량 산출, 공정 계획, 철근 조달이 분절적으로 이루어지며 수작업 재입력 반복됩니다.' },
        change: { title: '변경 관리 부재', description: '설계 변경 시 전면 재작업 필요. 공기 지연과 원가 상승의 주원인입니다.' },
      },
    },
    solution: {
      title: 'AISIMS',
      subtitle: '구조설계서 기반 End-to-End 자동화',
      tagline: "구조설계서를 단순 문서가 아닌 '시공 실행을 위한 데이터의 원천'으로 재정의합니다.",
      items: {
        parsing: { title: 'Data Parsing', description: '구조 데이터 추출 & 표준 DB화' },
        bim: { title: 'Auto-BIM', description: '무설정 BIM 자동 생성' },
        execution: { title: 'Execution Ready', description: '물량(QTO) / 공정(ASS) / 조달(Procurement)' },
        revision: { title: 'Revision Loop', description: '설계 변경 시 자동 갱신' },
      },
    },
    pipeline: {
      title: 'Execution Pipeline',
      subtitle: '설계부터 조달까지 끊김 없는(Seamless) 데이터 흐름 구현',
      stages: {
        stage1: { title: 'Input', description: '구조설계서 PDF Auto-parsing' },
        stage2: { title: 'Structural DB', description: '노드, 부재, 단면, 배근 정보 표준화' },
        stage3: { title: 'Optimization', description: 'SLP 기반 철근 최적화 (CO₂ 저감)' },
        stage4: { title: 'Outputs', description: '2D Shop Drawing, BBS, BOQ 자동 생성' },
        stage5: { title: 'Integration', description: '공정표 자동 생성(ASS) 및 조달 연계' },
      },
    },
    roadmap: {
      title: '성장 전략',
      phases: {
        phase1: { period: '2025-2027', title: 'Project Service', description: 'AISIMS 기반 프로젝트 단위 용역 (구조 BIM, 물량, 공정). 국내·해외 Pilot 프로젝트를 통한 레퍼런스 확보.' },
        phase2: { period: '2027-2029', title: 'SaaS & Vertical Expansion', description: '구독형(SaaS) 모델 전환 및 현장 라이선스 과금. 건축 분야 수직 확장 (AIMIMS, AIEIMS).' },
    ...
    values: {
      ...
      customerSuccess: { title: '고객 신뢰', description: '고객의 성공은 곧 우리의 성공입니다.' },
      integrity: { title: '투명성', description: '모든 과정이 정직하고 투명합니다.' },
      excellence: { title: '탁월함', description: '최고의 솔루션과 지원을 제공합니다.' },
    },
  },
  ...
  resourcesPage: {
    title: '리소스',
    subtitle: 'AICONS의 연구 논문 및 특허, 서비스 자료를 확인하세요',
    ...
    patents: {
      ...
      items: {
        patent1: {
          title: '기둥과 보 연결부의 개량형 거푸집 구조',
          number: '특허 제10-2831238호',
          date: '2025.07.03',
          country: 'KR',
        },
        patent2: {
          title: '두꺼운 기둥과 보 연결부의 개량형 거푸집 구조',
          number: '특허 제10-2831236호',
          date: '2025.07.03',
          country: 'KR',
        },
        patent3: {
          title: '동일 폭의 기둥과 보 연결부의 개량형 거푸집 구조',
          number: '특허 제10-2831237호',
          date: '2025.07.03',
          country: 'KR',
        },
        patent4: {
          title: '비정형 성형체 제작장치, 이를 이용한 성형물질 주형 및 간형 모구',
          number: '특허 ZL 2015 8 0044454.1 (CN 106660226 B)',
          date: '2019.06.11',
          country: 'CN',
        },
        patent5: {
          title: '비정형 성형체 제조장치, 그리고 이를 이용한 성형물질 거푸집 및 로드형 몰드',
          number: '특허 제10-1691798호',
          date: '2016.12.27',
          country: 'KR',
        },
        patent6: {
          title: '행거 타입 교량 슬래브거푸집 장치 및 이를 이용한 교량 슬래브거푸집 공사방법',
          number: '특허 제10-1691634호',
          date: '2016.12.26',
          country: 'KR',
        },
        patent7: {
          title: '반자동 거푸집 패널표면 청소장치',
          number: '특허 제10-1247598호',
          date: '2013.03.20',
          country: 'KR',
        },
        patent8: {
          title: '거포랜프존에서 연결되는 PC기둥 및 보유닛의 조립식 구조',
          number: '특허 제10-1260392호',
          date: '2013.04.26',
          country: 'KR',
        },
        patent9: {
          title: '거포랜프존을 이용한 PC기둥 접합구조',
          number: '특허 제10-1308053호',
          date: '2013.09.06',
          country: 'KR',
        },
        patent10: {
          title: '거포랜프존을 이용한 PC기둥 접합구조',
          number: '특허 제10-1308055호',
          date: '2013.09.06',
          country: 'KR',
        },
        patent11: {
          title: 'PC 라멘조를 위한 외부 건식벽체 유닛 구조, 및 이의 시공방법',
          number: '특허 제10-1285189호',
          date: '2013.06.28',
          country: 'KR',
        },
        patent12: {
          title: '철골 플레이트 또는 패널에 철근 삽입을 위한 열근가이더, 및 이를 이용한 철근 배근방법',
          number: '특허 제10-1249922호',
          date: '2013.03.27',
          country: 'KR',
        },
        patent13: {
          title: '탈부착형 등떼보강장치 및 이를 이용한 PC구조 시공방법',
          number: '특허 제10-1249921호',
          date: '2013.03.27',
          country: 'KR',
        },
        patent14: {
          title: 'PC기둥 접합구조',
          number: '특허 제10-1228012호',
          date: '2013.01.24',
          country: 'KR',
        },
        patent15: {
          title: 'PC기둥 거푸집장치 및 이를 이용한 PC기둥 생산방법',
          number: '특허 제10-1217683호',
          date: '2012.12.21',
          country: 'KR',
        },
        patent16: {
          title: 'PC보 거푸집장치 및 이를 이용한 PC보 생산방법',
          number: '특허 제10-1216557호',
          date: '2012.12.21',
          country: 'KR',
        },
        patent17: {
          title: '비정형 성형체 제조장치, 이를 이용한 성형 재료 타설용 거푸집 및 로드형 몰드',
    ...
    downloads: {
      ...
      items: {
        dl1: {
          title: 'AICONS 기업 소개서',
          description: 'AICONS의 비전, 기술력, 주요 실적을 소개합니다.',
          pages: '16페이지',
        },
        dl2: {
          title: 'AISIMS 서비스 안내서',
          description: 'AISIMS의 기능과 적용시 개선 효과를 안내합니다.',
          pages: '12페이지',
        },
        dl3: {
          title: 'AI 프로그램 사용 가이드',
          description: 'AI 기술 연계 방법 및 활용에 대한 가이드입니다.',
          pages: '18페이지',
        },
      },
    },
