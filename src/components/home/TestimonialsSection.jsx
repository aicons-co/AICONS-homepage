  ...
  return (
    <section className="py-20 bg-white">
      <div className="container-custom">
          ...
          {testimonials.slice(0, 3).map((testimonial, index) => (
            ...
            >
              ...
              <div className="border-t pt-4">
                <p className="font-semibold text-neutral-950">{testimonial.company}</p>
                <p className="text-sm text-gray-500">{testimonial.project}</p>
                <p className="text-sm text-primary-500 mt-1">{testimonial.author}</p>
              </div>
            </motion.div>
          ))}
        </div>
        ...
        <div className="relative bg-gradient-to-br from-neutral-950 to-neutral-900 rounded-2xl p-8 md:p-12 overflow-hidden">
          ...
          <AnimatePresence mode="wait">
            ...
            >
              <Quote className="w-16 h-16 text-primary-500/30 mb-6" />
            ...
            {testimonials.map((_, index) => (
              <button
                ...
                className={`w-2 h-2 rounded-full transition-all ${
                  index === currentIndex ? 'bg-primary-500 w-6' : 'bg-white/30'
                }`}
              />
            ))}
          </div>
