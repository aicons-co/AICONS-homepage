...
function SolutionPage({ solutionKey }) {
  ...
  if (!solution) {
    return (
      <div className="container-custom py-20 text-center">
        ...
        <Link to="/solutions/parsing" className="text-primary-500 hover:underline">
  ...
  return (
    <div>
      {/* Hero */}
      <section className="py-16 bg-gradient-to-br from-neutral-950 to-neutral-900">
        <div className="container-custom">
          ...
          <div className="flex items-center gap-6">
            ...
            <div>
              <h1 className="text-4xl md:text-5xl font-bold text-white mb-2">{solution.name}</h1>
              <p className="text-xl text-gray-300">{solution.tagline}</p>
            </div>
          </div>

          <p className="mt-6 text-gray-400 max-w-3xl">{solution.description}</p>
        </div>
      </section>
      ...
      {solution.metrics && (
        <section className="py-16 bg-gray-50">
          <div className="container-custom">
            <h2 className="text-2xl font-bold text-neutral-950 text-center mb-10">{t('solutionsPage.keyMetrics')}</h2>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              {Object.entries(solution.metrics).map(([key, metric], index) => (
                ...
                >
                  <div className="text-3xl md:text-4xl font-bold text-primary-500 mb-2">{metric.value}</div>
      ...
      {solution.features && (
        <section className="py-20 bg-white">
          <div className="container-custom">
            <h2 className="text-2xl font-bold text-neutral-950 text-center mb-12">{t('solutionsPage.keyCapabilities')}</h2>
              ...
              {solution.features.map((feature, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <h3 className="font-semibold text-neutral-950 mb-2">{feature.title}</h3>
      ...
      {solution.useCases && (
        <section className="py-20 bg-gray-50">
          <div className="container-custom">
            <h2 className="text-2xl font-bold text-neutral-950 text-center mb-4">{t('solutionsPage.useCases')}</h2>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {solution.useCases.map((useCase, index) => (
                ...
                >
                  ...
                  <h3 className="text-lg font-bold text-neutral-950 mb-3">{useCase.title}</h3>
      ...
      {solution.workflow && (
        <section className="py-20 bg-white">
          <div className="container-custom">
            <h2 className="text-2xl font-bold text-neutral-950 text-center mb-12">{t('solutionsPage.workflow')}</h2>
            <div className="max-w-4xl mx-auto">
              <div className="relative">
                {/* Timeline line */}
                <div className="absolute left-6 top-0 bottom-0 w-0.5 bg-primary-500/20 hidden md:block" />
                ...
                <div className="space-y-6">
                  {solution.workflow.map((step, index) => (
                    ...
                    >
                      <div className="w-12 h-12 rounded-full bg-primary-500 text-white flex items-center justify-center font-bold flex-shrink-0 z-10">
                        {step.step}
                      </div>
                      <div className="flex-1 bg-gray-50 rounded-xl p-5 -mt-1">
                        <h3 className="font-semibold text-neutral-950 mb-2">{step.title}</h3>
      ...
      {/* {solution.recommendedProducts && (
        <section className="py-16 bg-gray-50">
          <div className="container-custom">
            <h2 className="text-2xl font-bold text-neutral-950 text-center mb-8">{t('solutionsPage.recommendedProducts')}</h2>
            <div className="flex flex-wrap justify-center gap-4">
              {solution.recommendedProducts.map((productKey) => (
                ...
                >
                  <span className="font-semibold text-neutral-950">{productNames[productKey]}</span>
      ...
      {/* <section className="py-20 bg-primary-500">
        <div className="container-custom text-center">
          ...
          <Link
            to="/demo"
            className="inline-flex items-center gap-2 bg-white text-primary-500 px-8 py-4 rounded-lg font-semibold hover:bg-gray-100 transition-colors"
          >
...
function SolutionsIndex() {
  ...
  return (
    <div>
      ...
      <section className="py-20 bg-white">
        <div className="container-custom">
          {/* <h2 className="text-2xl font-bold text-neutral-950 mb-8 text-center">{t('solutionsPage.techTitle')}</h2> */}
